...
generateBody <- function(path, info) {
    ...
    content <- format("{content}\n      callSuper()", content=content)
    content <- format("{content}\n", content=content)
    content <- format("{content}\n      # `.options` contains the options", content=content)
    content <- format("{content}\n      # `.options$dataset()` contains the data", content=content)
    content <- format("{content}\n      # `.results` contains the results object (to populate)", content=content)
    content <- format("{content}\n    }", content=content)
    content <- format("{content})\n", content=content)
...
generateHeader <- function(path, info) {
    ...
    content <- format("{content}silky{name} <- function(", name=info$name, content=content)  # function name
    ...
    content <- format("{content}  options <- Options(", content=content)
    sep <- "\n"
    for (option in info$options) {
